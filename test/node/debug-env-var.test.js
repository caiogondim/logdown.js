...
describe('NODE_DEBUG and DEBUG environment variables', () => {
  ...
  const envVars = ['NODE_DEBUG', 'DEBUG']
  ...
  envVars.forEach(envVar => {
    ...
    it(
      '`' +
        envVar +
        '=*foo` enables only instances with names ending with “foo”',
      () => {
        process.env[envVar] = '*foo'
        logdown._setPrefixRegExps()
    ...
    it(
      '`' +
        envVar +
        '=foo*` enables only instances with names beginning with “foo”',
      () => {
        process.env[envVar] = 'foo*'
        logdown._setPrefixRegExps()
    ...
    it(
      '`' +
        envVar +
        '=*,-foo` enables all but only instances with “foo” prefix',
      () => {
        process.env[envVar] = '*,-foo'
        logdown._setPrefixRegExps()
    ...
    it(
      '`' +
        envVar +
        '=*,-*foo` enables all but instances with names ending with “foo”',
      () => {
        process.env[envVar] = '*,-*foo'
        logdown._setPrefixRegExps()
    ...
    it(
      '`' +
        envVar +
        '=*,-foo*` enables all but instances with names beginning with “foo”',
      () => {
        process.env[envVar] = '*,-foo*'
        logdown._setPrefixRegExps()
